...
export default function DashboardOverview() {
  ...
  const upcomingEvents = [
    { title: "Emergency flood relief meeting", time: "2026-07-12 at 10:00 AM · Savar Upazila Office", badge: "high", badgeColor: "bg-emerald-100 text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-400 dark:border-emerald-900", icon: CalendarDays },
    { title: "Monthly volunteer training session", time: "2026-07-15 at 02:00 PM · Tetuljhora Community Center", badge: "medium", badgeColor: "bg-amber-100 text-amber-700 dark:bg-amber-950/50 dark:text-amber-400 dark:border-amber-900", icon: BookOpen },
    { title: "Eid food package distribution", time: "2026-07-18 at 08:00 AM · All union centers", badge: "high", badgeColor: "bg-emerald-100 text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-400 dark:border-emerald-900", icon: Star },
  ];
