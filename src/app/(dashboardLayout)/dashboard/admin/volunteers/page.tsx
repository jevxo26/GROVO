...
const volunteersData = [
  { id: "1", name: "Dr. Sarah Hossain", district: "Dhaka, Dhaka", code: "VOL-DHK-0124", location: "Savar", members: 87, score: 94, rank: "Gold", status: "active" },
  { id: "2", name: "Md. Rafiqul Islam", district: "Chattogram, Chattogram", code: "VOL-CTG-0045", location: "Pahartali", members: 65, score: 88, rank: "Gold", status: "active" },
  { id: "3", name: "Nusrat Jahan", district: "Rajshahi, Rajshahi", code: "VOL-RAJ-0023", location: "Paba", members: 54, score: 82, rank: "Silver", status: "active" },
  { id: "4", name: "Abdullah Al Mamun", district: "Sylhet, Sylhet", code: "VOL-SYL-0078", location: "Golapganj", members: 43, score: 76, rank: "Silver", status: "active" },
  { id: "5", name: "Rokeya Begum", district: "Khulna, Khulna", code: "VOL-KHU-0034", location: "Dumuria", members: 38, score: 72, rank: "Bronze", status: "active" },
  { id: "6", name: "Tanvir Ahmed", district: "Dhaka, Dhaka", code: "VOL-DHK-0201", location: "Dhamrai", members: 0, score: 0, rank: "New", status: "pending" },
  { id: "7", name: "Sharmin Akhter", district: "Rangpur, Rangpur", code: "VOL-RNG-0012", location: "Pirgacha", members: 28, score: 68, rank: "Bronze", status: "active" },
                ...
                <TableRow key={volunteer.id} className="hover:bg-muted/50 border-border group transition-colors">
                  ...
                  <TableCell>
                    <div className="flex items-center gap-3">
                      <Progress value={volunteer.score} className="h-1.5 bg-muted [&>div]:bg-teal-600" />
                      <span className="text-sm font-bold text-foreground w-6">{volunteer.score}</span>
                    </div>
                  </TableCell>
                  <TableCell>
