...
const VolunteerPage = () => {
  return (
    <div className="min-h-screen w-full bg-white dark:bg-[#051108] transition-colors duration-300">
      ...
      {/* 1. Hero Section */}
      <div className="w-full bg-[#FBF9F5] dark:bg-[#0f1d12] border-b border-slate-200/80 dark:border-gray-800 py-12 md:py-20 mb-16">
        <div className="max-w-[91.666667%] mx-auto px-4 sm:px-6 lg:px-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="flex flex-col items-start text-left">
              ...
              <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold text-slate-900 dark:text-white mb-5 sm:mb-6 tracking-tight leading-[1.15]">
                Be the <span className="text-green-600">Change</span> You Want <br className="hidden sm:inline" /> to See
              </h1>
              <p className="text-slate-600 dark:text-gray-300 text-base sm:text-lg md:text-xl max-w-xl mb-8 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto">
                <Link 
                  href="#register" 
                  className="bg-green-600 hover:bg-green-700 text-white font-medium text-base px-8 py-4 rounded-xl transition flex items-center justify-center gap-2 shadow-lg shadow-green-600/20 text-center"
                >
                ...
                <Link 
                  href="#contact" 
                  className="bg-transparent hover:bg-black/5 dark:hover:bg-white/10 text-slate-900 dark:text-white border border-slate-300 dark:border-gray-700 font-medium text-base px-8 py-4 rounded-xl transition text-center"
                >
                  Contact Coordinator
                </Link>
              </div>
      ...
      <div className="max-w-[91.666667%] mx-auto px-4 sm:px-6 lg:px-20 mb-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <div key={idx} className="bg-transparent border-0 shadow-none p-8 text-center relative">
              <div className="w-15 h-14 rounded-xl bg-green-600 text-white font-bold text-lg flex items-center justify-center mx-auto mb-6 shadow-md shadow-green-600/30">
                {item.step}
              </div>
      ...
      <div className="w-full bg-[#FBF9F5] dark:bg-[#051108] py-16 md:py-24 border-y border-slate-200/80 dark:border-gray-800">
        <div className="max-w-[91.666667%] mx-auto px-4 sm:px-6 lg:px-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              { icon: <IdCard className="w-6 h-6 text-green-600 dark:text-green-400" />, title: "Digital ID Card", desc: "Receive a verified digital volunteer card with QR code." },
              { icon: <Award className="w-6 h-6 text-green-600 dark:text-green-400" />, title: "Certificates", desc: "Earn certificates and badges for your contributions." },
              { icon: <TrendingUp className="w-6 h-6 text-green-600 dark:text-green-400" />, title: "Track Impact", desc: "Monitor your field activities and see your real impact." },
              { icon: <Calendar className="w-6 h-6 text-green-600 dark:text-green-400" />, title: "Events & Training", desc: "Access exclusive volunteer events and training programs." },
              { icon: <Users className="w-6 h-6 text-green-600 dark:text-green-400" />, title: "Community", desc: "Join a nationwide network of humanitarian volunteers." },
              { icon: <Gift className="w-6 h-6 text-green-600 dark:text-green-400" />, title: "Rewards", desc: "Receive appreciation gifts and recognition for excellence." },
            ].map((benefit, idx) => (
              <div key={idx} className="bg-white dark:bg-[#0f1d12] p-6 sm:p-8 rounded-3xl border border-slate-200/80 dark:border-gray-800 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-start text-left">
