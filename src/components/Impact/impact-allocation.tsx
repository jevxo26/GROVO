...
export const ImpactAllocation = ({ fadeInUp }: { fadeInUp: any }) => (
  <section className="px-6 py-16 max-w-5xl mx-auto">
    ...
    >
      ...
      >
        Fund Allocation <span className="text-[#058235] dark:text-green-400">Breakdown</span>
      </h2>
    </motion.div>
    ...
    >
      ...
      {/* Progress Bar */}
      <div className="w-full h-8 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden flex shadow-inner">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-8 pt-2">
        {fundAllocationData.map((item) => (
          <div 
            ...
            border-b border-gray-200/60 dark:border-gray-700 pb-3"
          >
            ...
            <span className="font-bold text-gray-700 dark:text-gray-200 text-sm sm:text-base">
              {item.percentage}%
            </span>
          </div>
        ))}
