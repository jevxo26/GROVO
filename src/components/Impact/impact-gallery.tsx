...
export const ImpactGallery = ({ fadeInUp, staggerContainer }: { fadeInUp: any; staggerContainer: any }) => (
  <section className="px-6 py-16 max-w-6xl mx-auto">
    ...
    >
      ...
      <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif font-bold text-gray-900 mb-3">
        Impact in <span className="text-[#058235]">Pictures</span>
      </h2>
    ...
    >
      {galleryImagesData.map((item) => (
        <motion.div
          ...
          className="relative group overflow-hidden rounded-2xl h-52 shadow-sm"
        >
          <Image
            src={item.imageUrl}
            alt={item.title}
