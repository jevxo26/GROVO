...
const DeleteCampaignModal = ({ isOpen, onClose, onDelete }: DeleteCampaignModalProps) => {
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} title="Delete Campaign" maxWidth="max-w-md">
