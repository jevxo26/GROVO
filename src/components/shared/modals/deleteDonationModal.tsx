...
const DeleteDonationModal = ({ isOpen, onClose, onDelete }: DeleteDonationModalProps) => {
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} title="Delete Donation" maxWidth="max-w-md">
