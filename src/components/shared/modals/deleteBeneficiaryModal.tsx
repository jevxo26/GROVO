// components/shared/modals/deleteBeneficiaryModal.tsx
"use client";
...
const DeleteBeneficiaryModal = ({ isOpen, onClose, onDelete }: DeleteBeneficiaryModalProps) => {
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} title="Delete Beneficiary" maxWidth="max-w-md">
