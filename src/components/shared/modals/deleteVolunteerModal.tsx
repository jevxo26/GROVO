...
const DeleteVolunteerModal = ({ isOpen, onClose, onDelete, volunteerName }: DeleteVolunteerModalProps) => {
  return (
    <BaseModal isOpen={isOpen} onClose={onClose} title="Delete Volunteer" maxWidth="max-w-md">
      <div className="space-y-6">
        <div>
          <p className="text-base text-gray-700 dark:text-gray-200">
            Are you sure you want to delete this volunteer{volunteerName ? ` (${volunteerName})` : ""}?
          </p>
